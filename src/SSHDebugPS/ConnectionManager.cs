...
namespace Microsoft.SSHDebugPS
{
    ...
    {
        public static DockerConnection GetDockerConnection(string name, bool isLinuxContainers)
        {
           if (string.IsNullOrWhiteSpace(name))
            ...
            if (!DockerConnection.TryConvertConnectionStringToSettings(name, out settings, out remoteConnection) || settings == null)
            {
                ...
                bool success = ShowContainerPickerWindow(IntPtr.Zero, isLinuxContainers, out connectionString);
                if (success)
                {
