...
namespace DebuggerTesting.OpenDebug.CrossPlatCpp
{
    ...
    public class LaunchCommand : LaunchCommand<CppLaunchCommandArgs>
    {
        ...
        public LaunchCommand(IDebuggerSettings settings, string program, string visualizerFile = null, bool isAttach = false, bool showDisplayString = false, params string[] args) :
            this(settings, program, null, visualizerFile, isAttach, showDisplayString, args)
        {
        }

        public LaunchCommand(IDebuggerSettings settings, string program, string cwd, string visualizerFile = null, bool isAttach = false, bool showDisplayString = false, params string[] args)
        {
            ...
            else
            {
                ...
                this.Args.ShowDisplayString = showDisplayString;
            }
        }
