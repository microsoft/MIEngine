    ...
    public class CwdTests : TestBase
    {
        ...
        public void TestProgramDirectory(ITestSettings settings)
        {
            ...
            using (IDebuggerRunner runner = CreateDebugAdapterRunner(settings))
            {
                ...
                LaunchCommand launch = new LaunchCommand(settings.DebuggerSettings, debuggee.OutputPath, null, null, false, false);
        ...
        public void TestTestFolderDirectory(ITestSettings settings)
        {
            ...
            using (IDebuggerRunner runner = CreateDebugAdapterRunner(settings))
            {
                ...
                LaunchCommand launch = new LaunchCommand(settings.DebuggerSettings, debuggee.OutputPath, path, null, false, false);
                runner.RunCommand(launch);
